...
cov_code_generator.print_string("Equations for covariance matrix prediction")
...
kalman_gain_code_generator.write_matrix(Matrix(K_simple[1]), "K", True)
